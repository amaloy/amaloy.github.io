...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_jquery__ = __webpack_require__(166);
...
const MenuItem = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createClass({
...
const MenuList = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createClass({
  ...
  render: function () {
    ...
    const renderedItems = this.state.items.map(function (item) {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(MenuItem, {
        label: item.id,
        type: type,
...
const MainContent = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createClass({
  ...
  render: function () {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { dangerouslySetInnerHTML: { __html: this.state.content } });
  }
});

const mainContent = __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(MainContent, null), document.getElementById('mainContent'));
...
const menuAlways = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
  'div',
  null,
  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    'a',
    { title: 'Current backend: ' + SERVICE_URL, href: switchBackendHref() },
    TOGGLE_BACKEND
  )
);
    ...
    if (link === EVERYTHING) {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'a',
            { href: HOST_LOCAL + RESUME_PATH + 'swagger' },
            'swagger doc'
          )
        ),
        menuAlways
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(MenuList, {
        type: link,
        href: json[LINKS][link].href,
        callback: parseContent
      });
